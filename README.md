...
[![GoDoc](https://godoc.org/cel.dev/cel-go?status.svg)][6]
...
> issue](https://cel.dev/cel-go/issues/1329) for details.
...
[4]:  https://cel.dev/cel-go/issues
[5]:  https://bazel.build
[6]:  https://godoc.org/cel.dev/cel-go
